...
${OBJECTDIR}/InitializationManager.o: InitializationManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InitializationManager.o InitializationManager.cpp
...
${TESTDIR}/tests/InitializerTest.o: tests/InitializerTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/InitializerTest.o tests/InitializerTest.cpp


${TESTDIR}/tests/InitializerTestRunner.o: tests/InitializerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/InitializerTestRunner.o tests/InitializerTestRunner.cpp
...
${OBJECTDIR}/InitializationManager_nomain.o: ${OBJECTDIR}/InitializationManager.o InitializationManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InitializationManager_nomain.o InitializationManager.cpp;\
	else  \
